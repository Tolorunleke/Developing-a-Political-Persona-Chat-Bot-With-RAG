...
class GppVersion {
   ...
   * @returns {Object} - gppData: { consentString: string, consent: boolean | null, sectionPrefix: string };
   */
...
function launchPadStart(configUpdates) {
  ...
  const defaultConfig = {"id":null,"env":"production","configVersion":null,"logging":false,"atsRules":[],"preload":true,"libraryVersion":"2.0.2","geoTargetingUrl":"https://geo.privacymanager.io","atsConfigUrl":"https://ats-wrapper.privacymanager.io"} || _liverampCmpUtils.config.generate();
